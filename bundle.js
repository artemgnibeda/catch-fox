...
var copy=require("copy-to-clipboard");document.addEventListener("keypress",function(e){if(99===e.keyCode){var r=document.querySelector("svg"),o=r.innerHTML;copy('<!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd"> <svg width="100px" height="100px" version="1.1" baseProfile="full" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:ev="http://www.w3.org/2001/xml-events">'+o+"</svg>")}});var createViewer=require("../index"),viewer=createViewer({width:.2,height:.2,followMouse:!0,followMotion:!0});document.getElementById('fox').appendChild(viewer.container);
